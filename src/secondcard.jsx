  ...
  return (
    <div className="container">
      ...
      <div className="scrollable-content">
        ...
        <p>
          <i className="fa-brands fa-react" style={{ color: "aqua" }}></i> React
        </p>
        <p style={{ color: "grey" }}>
        ...
        <p style={{ color: "grey" }}>
          Variables, Data Types, Operators, Type Conversion, Coercion, Function
          Declarations, Expressions, Arrow Functions, Parameters, Default
          Parameters, Higher-Order Functions, Callbacks, Object Literals,
          Properties, Methods, Array Methods, Destructuring, Spread/Rest
          Operators
        </p>
        <p>
          <i className="fa-brands fa-html5" style={{ color: "orange" }}></i>{" "}
        ...
        <p style={{ color: "gray" }}>
          ...
          Grid-container, Grid-items, Grid-template, Grid-areas, Gap, Auto-flow,
          Font-family, Font-size, Font-weight, Line-height, Text-align,
          Text-decoration, Color, Background-color, Background-image, Opacity,
          RGB/HSL.
        </p>
        <p>
          <i className="fa-solid fa-microchip" style={{ color: "red" }}></i> AI
        </p>
        <p style={{ color: "gray" }}>
          ...
          technical challenges. My strength lies in formulating clear, detailed
          queries to guide the AI toward the most effective answers. Integrating
          these tools into my daily routine has become a key part of my
          problem-solving process.
        </p>
        <p>
          <i className="fa-brands fa-git-alt" style={{ color: "blue" }}></i> Git
          (Version Control)
        </p>
        <p style={{ color: "gray" }}>
